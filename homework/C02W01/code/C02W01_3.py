...
def gradient_check(x, theta, epsilon=1e-7):
    ...
    numerator = np.linalg.norm(grad - gradapprox)  # Step 1' 计算分子的范数
    denominator = np.linalg.norm(grad) + np.linalg.norm(gradapprox)  # Step 2' 计算分母
