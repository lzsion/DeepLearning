...
# print(arr3D.shape)  # (3, 3, 6)
# print((np.pad(arr3D, ((0, 0), (1, 1), (2, 2)), 'constant')).shape)  # (3, 5, 10)
...
def conv_forward(A_prev, W, b, hparameters):
    ...
    for i in range(m):  # 遍历样本
        a_prev_pad = A_prev_pad[i]  # 选择第i个样本的扩充后的激活矩阵 (n_H_prev, n_W_prev, n_C_prev)
...
# 池化反向传播
# 池化虽然没有学习参数，但相当于将数据与一个卷积核卷积，(取最大或求平均)
# 将这个卷积核假装成w计算反向传播
